    ...
    <script type="text/javascript">
        ...
        $(function () {
			...
			$("#findBtn").click(function (){
				...
				$("#hidden-stage").val($.trim($("#find-stage").val()));
				$("#hidden-type").val($.trim($("#find-type").val()));
				$("#hidden-source").val($("#find-source").val());
				$("#hidden-contactsId").val($("#find-contactsId").val());
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (i, n) {
                        tranBody += '<tr>';
                        tranBody += '<td><input type="checkbox" name="xz" id="' + n.id + '"/></td>';
        ...
        function pageList(pageNo, pageSize) {
            ...
            $("#find-stage").val($.trim($("#hidden-stage").val()));
            $("#find-type").val($.trim($("#hidden-type").val()));
            $("#find-source").val($.trim($("#hidden-source").val()));
            ...
            $.ajax({
                ...
                data: {
                    ...
                    "stage": $.trim($("#find-stage").val()),
                    "type": $.trim($("#find-type").val()),
                    "source": $.trim($("#find-source").val()),
                    "contactsId": $.trim($("#find-contactsId").val())
                },
                dataType: "json",
                success: function (data) {
                    //data {"total":?,"dataList":"[{},{},...]"}
...
<input id="hidden-customerId" type="hidden"/>
<input id="hidden-stage" type="hidden"/>
<input id="hidden-type" type="hidden"/>
<input id="hidden-source" type="hidden"/>
<input id="hidden-contactsId" type="hidden"/>

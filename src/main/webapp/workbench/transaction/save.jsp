            ...
            $("#create-accountName").typeahead({
                source: function (query, process) {
                    $.get(
                        ...
                        {"name": query},
                        function (data) {
                            //data {"name1":String,"name2":String}
                            process(data);
                        },
                        "json"
                    )
...
<div style="position:  relative; left: 30px;">
    ...
    <div style="position: relative; top: -40px; left: 70%;">
        ...
        <button type="button" class="btn btn-default" id="saveExitBtn">取消</button>
    </div>
    <hr style="position: relative; top: -40px;">
</div>
<form class="form-horizontal" role="form" style="position: relative; top: -30px;" id="saveTranForm" method="post" action="workbench/transaction/save.do">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            <!--搜索功能不做了，直接写死-->
            <input type="text" class="form-control" id="create-activitySrc" value="发卡片">
            <input type="hidden" id="create-activityId" value="df2e98ff2f35408797f0352f2c8eab9c" name="activityId"/>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            ...
            <input type="hidden" id="create-contactsId" value="5d623c9062d541b282de385f40cbb971" name="contactsId"/>
        </div>
    </div>
